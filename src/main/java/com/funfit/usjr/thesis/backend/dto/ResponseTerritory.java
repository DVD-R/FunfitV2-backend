...
public class ResponseTerritory implements Serializable{
	private int id;
	...
	public ResponseTerritory(){}
	
	public ResponseTerritory(int id, String encoded_polyline, String status, int level, String faction_description) {
		super();
		this.id = id;
